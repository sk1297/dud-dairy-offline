...
export default function Delivery() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100dvh', background: 'var(--bg)', paddingBottom: 'calc(var(--nav-h) + env(safe-area-inset-bottom, 36px) + 100px)' }}>
      ...
      {undoBar && (
        <div style={{
          position: 'fixed', bottom: `calc(var(--nav-h) + env(safe-area-inset-bottom, 36px) + 64px)`, left: '50%', transform: 'translateX(-50%)',
      ...
      {/* Summary Footer */}
      <div style={{
        position: 'fixed', bottom: 'calc(var(--nav-h) + env(safe-area-inset-bottom, 36px))', left: '50%', transform: 'translateX(-50%)',
